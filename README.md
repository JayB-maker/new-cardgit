...
The `/pricing` page reads its display currency, plan prices, and annual discount percentages from server environment variables. The default values in `.env.example` use pound sterling.
